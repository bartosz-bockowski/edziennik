    ...
    <div class="card mb-4 box-shadow">
        ...
        <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
                ...
                <li><a class="btn btn-primary my-1" href="/student/${loggedUser.student.id}/details"><spring:message code="student.details "/></a></li>
            </ul>
        </div>
    </div>
</c:if>
    ...
    <div class="card mb-4 box-shadow">
        ...
        <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
                ...
                <li><a class="btn btn-primary my-1" href="/parent/${loggedUser.parent.id}/details"><spring:message code="parent.details"/></a></li>
            </ul>
        </div>
    </div>
</c:if>
    ...
    <div class="card mb-4 box-shadow">
        ...
        <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
                ...
                <li><a class="btn btn-primary my-1" href="/teacher/${loggedUser.teacher.id}/details"><spring:message code="teacher.details"/></a></li>
            </ul>
        </div>
    </div>
</c:if>
